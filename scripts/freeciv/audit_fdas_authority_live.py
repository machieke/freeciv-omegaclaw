#!/usr/bin/env python3
"""Audit a fresh engine-live bounded FDAS authority run."""
...
from freeciv.harness.fdas_authority_live import (  # noqa: E402
    audit_fdas_authority_live,
)
...
def main(argv=None):
    ...
    report = audit_fdas_authority_live(args.game_dir, repo=REPO)
    ...
    print(json.dumps({
        ...
        "authorized": report["summary"]["authorized"],
