#!/usr/bin/env python3
"""Audit a fixed replacement-capacity production lifecycle cohort."""
...
from freeciv.harness.fdas_replacement_capacity_production_lifecycle_cohort import (  # noqa: E402
