#!/usr/bin/env python3
"""Audit the retrospective replacement-chain consequence vector."""
...
from freeciv.harness.fdas_replacement_consequence import (  # noqa: E402
    audit_fdas_replacement_consequence,
)
...
def main(argv=None):
    ...
    report = audit_fdas_replacement_consequence(
        args.game_dir, args.parent_report, repo=REPO,
    ...
    print(json.dumps({
        ...
        "summary": report["consequence"]["summary"],
    }, sort_keys=True))
