#!/usr/bin/env python3
"""Audit the fixed fresh-seed replacement-capacity cohort."""
...
from freeciv.harness.fdas_replacement_capacity_cohort import (  # noqa: E402
