#!/usr/bin/env python3
"""Audit an engine-live paired FDAS belief-conflict cohort."""
...
from freeciv.harness.fdas_belief_conflict_live import (  # noqa: E402
...
def main(argv=None):
    ...
    report = audit_fdas_belief_conflict_live(
        args.cohort_root, repo=REPO)
    ...
    print(json.dumps({
        ...
        "context_quarantines": report["summary"]["context_quarantines"],
        "output": output,
