#!/usr/bin/env python3
"""Audit the fixed retained-capacity transition discovery cohort."""
...
from freeciv.harness.fdas_retained_capacity_transition_discovery import (  # noqa: E402
...
def main(argv=None):
    ...
    report = audit_fdas_retained_capacity_transition_discovery(
        args.run_dir,
