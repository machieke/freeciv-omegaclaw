#!/usr/bin/env python3
"""Audit the fixed fresh-seed replacement-readout cohort."""
...
from freeciv.harness.fdas_replacement_readout_cohort import (  # noqa: E402
...
def main(argv=None):
    ...
    print(json.dumps({
        ...
        "opportunity_games": report["summary"]["opportunity_game_count"],
        "output": output,
