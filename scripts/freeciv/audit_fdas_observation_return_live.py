#!/usr/bin/env python3
"""Audit an engine-live paired FDAS observation-return cohort."""
...
from freeciv.harness.fdas_observation_return_live import (  # noqa: E402
...
def main(argv=None):
    ...
    report = audit_fdas_observation_return_live(
