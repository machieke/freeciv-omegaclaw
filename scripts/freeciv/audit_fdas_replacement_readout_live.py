#!/usr/bin/env python3
"""Audit one engine-live coordinated-replacement candidate readout."""
...
from freeciv.harness.fdas_replacement_readout_live import (  # noqa: E402
...
def main(argv=None):
    ...
    report = audit_fdas_replacement_readout_live(args.game_dir, repo=REPO)
