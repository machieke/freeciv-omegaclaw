...
def test_replacement_capacity_retained_queue_lifecycle_requires_no_action():
    declaration = _enabled_city_declaration()
    manifest = declaration["manifest"]
    manifest["capabilities"]["replacement_capacity_demand"] = "shadow-live"
    manifest["replacement_capacity_demand_diagnostic"] = {
    ...
    manifest["replacement_capacity_retained_queue_lifecycle_diagnostic"] = {
        "action_selection_changed": False,
        "candidate_authority": False,
        "match_semantics": (
            "pressure-selected-grounded-candidate-matches-current-"
            "authoritative-queue"),
        "no_queue_action_submitted": False,
        "observation_authority": "later-authoritative-snapshot",
        "policy_authority": False,
