...
| 2 | Dependency indexes, support-aware invalidation, compatibility-record and rich-component incrementality, incremental/cold parity, leases | `fdas-phase2-dependency-materializer.md` |
