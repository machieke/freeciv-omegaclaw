...
| Replay failures | 0 |
| Authority readout p50 / p95 | 0.050 / 1.639 ms |
...
The report hash is
`f89bd7fc99e5a04883187a03d18756e1849adb3db72a3162d1704ca5a33a6a05`;
its implementation digest is
`ff5ce0112889e7a52aa5ea9b1a2fe600ba492ee0dcb4d5d18252c7325290df4d`.
