...
| Replay failures | 0 |
| Authority readout p50 / p95 | 0.048 / 1.554 ms |
...
The report hash is
`bb4a29a5df4d3be5a6cb64fd01d2163f4b7903b72e464ba8c781a9ed2e895f1b`;
its implementation digest is
`25bfb729429b50705b2962c5fce68be556a2afe6e1afe9d9689d21ecffad8d0a`.
