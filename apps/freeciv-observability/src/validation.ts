...
const knownTypes = [
  ...
  "teleology_estimated", "domain_estimate_emitted", "domain_estimate_abstained",
  "resource_schedule_decided", "resource_claim_requested", "resource_claim_reserved",
  "resource_claim_rejected", "resource_claim_released", "resource_capacity_changed",
  "operation_proposed", "operation_reserved", "operation_activated",
  "operation_step_selected", "operation_step_revalidated", "operation_step_committed",
  "operation_blocked", "operation_repaired", "operation_suspended",
  "operation_completed", "operation_failed", "operation_abandoned", "operation_expired",
